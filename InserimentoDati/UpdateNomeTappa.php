...
$sql = "UPDATE takeatrip_db.Tappa SET Tappa.nome='$nome' WHERE Tappa.emailProfilo='$emailProfilo' and Tappa.codiceViaggio='$codiceViaggio'and Tappa.ordine ='$ordine'and Tappa.codAccount ='$codAccount';"; 
